...
// 	console.log("iconSpace: " + iconSpace);
	...
	nvImageMenu.draw([
		...
		},
		{
			tag: 'img',
			id: 'imgwechatfriend',
			src: '/static/image/sharemenu/wechatfriend.png',
			position: {
				top: top1,
				left: left1,
				width: iconWidth,
		...
		},
		{
			tag: 'img',
			id: 'imgwechatmoments',
			src: '/static/image/sharemenu/wechatmoments.png',
			position: {
				top: top1,
				left: left2,
				width: iconWidth,
		...
		},
		{
			tag: 'img',
			id: 'imgweibo',
			src: '/static/image/sharemenu/weibo.png',
			position: {
				top: top1,
				left: left3,
				width: iconWidth,
		...
		},
		{
			tag: 'img',
			id: 'imgqq',
			src: '/static/image/sharemenu/qq.png',
			position: {
				top: top1,
				left: left4,
				width: iconWidth,
		...
		},
		{
			tag: 'img',
			id: 'imgcopyurl',
			src: '/static/image/sharemenu/copyurl.png',
			position: {
				top: top2,
				left: left1,
				width: iconWidth,
		...
		},
		{
			tag: 'img',
			id: 'imgmore',
			src: '/static/image/sharemenu/more.png',
			position: {
				top: top2,
				left: left2,
				width: iconWidth,
